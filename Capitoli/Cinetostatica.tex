...
\begin{equation}
    y_1 = \sqrt{4l^2-(x-d)^2}
\end{equation}
Per quanto riguarda il secondo caso è simmetrico al primo, la catena $\overrightarrow{AB}$ è parallela a $\overrightarrow{BC}$:
\begin{figure}[ht]
	\begin{center}
...
\begin{figure}[!ht]
	...
	\label{Caso4Sing}
\end{figure}
\\Si può trovare le soluzione del quarto caso imponendo \begin{equation}|\overrightarrow{EC}| = 0 \rightarrow x=d, y = 0
\end{equation}

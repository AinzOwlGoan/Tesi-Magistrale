...
La seconda fase è quella di input, in questa fase andiamo a prendere tutti i valori di posizione dei motori sia della vite che delle braccia. I valori vengono presi mediante i messaggi dalle PDO ed hanno bisogno di essere convertiti, proprio per questo la struttura di ricezione di un messaggio è la seguente: 
\begin{figure}[ht]
	\begin{center}
...
\begin{figure}[ht]
	...
	\end{center}
\end{figure}
Possiamo vedere lo schema in figura: \ref{fig:controlloBraccia}
...
[valuta se inserire spiegazione prima o dopo]